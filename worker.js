...
// Aplicacao do patch de permissoes homologado em staging. O HTML do Orcado
// tem mais de 1 MB e inclui a base orcamentaria embutida; o Worker aplica o
// patch validado ao servir a pagina, preservando o arquivo de dados original.
async function handleOrcadoComPermissoes(request, env) {
  ...
  try {
    ...
    return responseHtml(asset, injectIaTraceability(patched, 'orcado'), 'production-v2');
  } catch (error) {
