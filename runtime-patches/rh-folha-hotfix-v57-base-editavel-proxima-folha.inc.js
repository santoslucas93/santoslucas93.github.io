...
async function exportPdf57(){
  ...
  doc.addPage('a4','landscape');doc.setFillColor(7,26,44);doc.rect(0,0,297,27,'F');doc.setTextColor(255,255,255);doc.setFontSize(15);doc.text('Composição por colaborador',12,16);doc.autoTable({startY:33,head:[['Colaborador','Departamento','Salário','Proventos','Descontos','Líquido','Encargos','Benefícios','Custo']],body:t.rows.map(function(r){return[r.nome,r.departamento,money57(r.salary),money57(r.proventos),money57(r.descontos),money57(r.liquido),money57(r.encargos),money57(r.beneficios),money57(r.custo)]}),foot:[['TOTAL','', '',money57(t.proventos),money57(t.descontos),money57(t.liquido),money57(t.encargos),money57(t.beneficios),money57(t.custo)]],theme:'striped',styles:{fontSize:6.3,cellPadding:1.8},headStyles:{fillColor:[13,43,66]},footStyles:{fillColor:[234,242,246],textColor:[7,26,44],fontStyle:'bold'},columnStyles:{2:{halign:'right'},3:{halign:'right'},4:{halign:'right'},5:{halign:'right'},6:{halign:'right'},7:{halign:'right'},8:{halign:'right'}}});
...
function init57(){
  window.RH_FORECAST_V57=true;window.rhV57HandleCapture=handleCapture57;window.rhV57Refresh=refresh57;styles57();ensureWorkforceButton57();enhancePayroll57();
