...
function init84(){style84();[380,900,1700].forEach(function(ms){setTimeout(run84,ms)});document.addEventListener('rh:v80-rendered',function(){setTimeout(run84,20)});document.addEventListener('click',function(e){if(e.target&&e.target.closest&&e.target.closest('[data-plan-tab="13"],[data-plan-tab="ferias"]'))setTimeout(run84,420)},true)}
