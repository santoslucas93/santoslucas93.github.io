(function(){
  ...
  function addActions(bubble,trace,composition,legacy){
    if(!bubble||!trace||bubble.dataset.iaTraceRuntime)return;bubble.dataset.iaTraceRuntime='1';if(legacy)legacy.remove();const box=document.createElement('div');box.className='ia-trace-actions';
